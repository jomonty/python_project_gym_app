...
gym_class_1 = GymClass('Zumba', date(2022, 12, 15), time(7, 0, 0), 10, True)
gym_class_1 = gym_class_repo.save(gym_class_1)
gym_class_2 = GymClass('Conditioning', date(2022, 12, 19), time(6, 0, 0), 5, True)
...
gym_class_4 = GymClass('CrossFit', date(2022, 12, 10), time(17, 0, 0), 4, False)
